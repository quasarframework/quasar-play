<template>
  <div class="layout-padding tabs-playground">
    ...
    <q-tabs>
      <q-tab alert slot="title" label="Oaua" />
    ...
    <q-tabs color="brown" position="bottom">
      <q-tab default slot="title" name="three" label="Oaua" />
    ...
    <q-tabs v-model="tab">
      <q-tab alert slot="title" name="three" label="Oaua" />
    ...
    <q-tabs
      ...
      color="purple"
    >
      <q-tab slot="title" name="three" label="Oaua" />
      <q-tab slot="title" name="one" label="Gogu" />
      <q-tab slot="title" name="two" label="Gigiiiiiiiii sdfsdfs aadsf asfsda" />
    ...
    <q-tabs
      ...
      color="secondary"
    >
      <q-tab default slot="title" name="three" icon="bluetooth" />
    ...
    <q-tabs
      ...
      color="amber"
    >
      <q-tab default slot="title" name="three" label="Oaua" icon="bluetooth" />
    ...
    <q-tabs
      ...
      inverted
    >
      <q-tab alert default slot="title" name="three" icon="bluetooth" />
      <q-tab count="22" alert slot="title" name="one" icon="wifi" />
    ...
    <q-tabs
      ...
      inverted
    >
      <q-tab alert default slot="title" name="three" label="Oaua" icon="bluetooth" />
